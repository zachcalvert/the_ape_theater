...
SQUARE_APPLICATION_ID = os.environ.get('SQUARE_APPLICATION_ID', 'sandbox-sq0idp-2qiP_T3vwVGta8gl_zfE2g')
SQUARE_ACCESS_TOKEN = os.environ.get('SQUARE_ACCESS_TOKEN', 'sandbox-sq0atb-ajZpWXxIptdz8NPWX_sRFQ')
SQUARE_LOCATION_ID = os.environ.get('SQUARE_LOCATION_ID', 'CBASEAkhYkvMTp_dtcrg-zCqusMgAQ')
